        ...
        <div className="overflow-x-auto">
          <div className={styles.table_container}>
            {shows.length > 0 ? (
              ...
              <NoItem item={"We don't have any running shows, add one !"} />
            )}
          </div>
        </div>
      </div>
...
const styles = {
  ...
  view_details_btn:
    'p-0.5 mx-1 bg-orange-600 cursor-pointer text-white text-center font-medium rounded-md',
  update_disabled_btn:
    'p-0.5 mx-1 cursor-not-allowed bg-purple-400 text-white text-center font-medium rounded-md',
  update_btn:
    'p-0.5 mx-1 bg-purple-700 cursor-pointer text-white text-center font-medium rounded-md',
};
