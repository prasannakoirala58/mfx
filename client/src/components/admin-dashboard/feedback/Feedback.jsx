...
const styles = {
  ...
  input:
    'block w-[20%] mb-5 p-3 text-sm text-gray-400 border border-gray-500 rounded-lg cursor-pointer bg-gray-800',
  feedback_main: 'grid grid-cols-2 gap-3 md:grid-col-3 lg:grid-cols-4',
  feedback_card:
    'text-md font-extralight p-3 bg-gray-700 text-white flex flex-col justify-start items-start rounded',
  ...
  load_more_disabled:
    'bg-blue-400 cursor-not-allowed  rounded-md font-medium my-6 px-6 py-2 text-white',
};
